...
# =========================================================
def linear_schedule_with_floor(initial_lr, min_lr=1e-5):
...
def train_ppo(
    ...
    env_fns = [make_adroit_hammer_env(seed=i, render=False) for i in range(n_envs)]
    ...
    model.save("raw_ppo_adroit_hammer_final")
    return model
